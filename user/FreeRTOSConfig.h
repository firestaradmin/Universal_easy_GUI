...
//FreeRTOS 任务的最大优先级，与STM32中断相反，数值越大优先级越高，空闲任务为0
...
/* 此宏是用来管理最高中断优先级，可以看出此宏是 
configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY 左移4 位而来的，
此宏设置好以后，低于此优先级的中断可以安全的调用 FreeRTOS 的 API 函数，
高于此优先级的中断 FreeRTOS 是不能禁止的，
